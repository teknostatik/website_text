...
<!-- This template will help you build out your very own README, a great tool for transparently letting others know what it's like to work with you, and how you prefer to be communicated with. Each section is optional. You can remove those you aren't comfortable filling out, and add sections that are germane to you. This template was adapted from the one used at Gitlab. -->

I currently work as ITIL Operations Manager, in the Service Management Operations Team at the University of Birmingham. I'm also part of the leadership team for our Agile Community of Practice, and am interested in AI, sustainability, and especially the place where the two meet.

### About Me

I've worked at the University since October 2000, in a variety of different roles across Library Services, the IT Service Desk, New Core and Service Management. My [why](https://simonsinek.com/books/start-with-why/) is helping other people learn and improve. As well as the things I do professionally, I'm also interested in cycling, music, computer hardware and software, and sustainability. You can usually find me either sat at a computer, pedalling a bike, or when I'm working from home both at the same time. 

### Myers-Briggs / 16 Personalities

I'm an [INTJ](https://www.16personalities.com/intj-personality), with a clear preference for all four of those letters. I think this description is very accurate:
...
* I'm good at learning new things, and reaching a decent level of proficiency in a relatively short time. 
* I have a wide breadth of knowledge, with a few different depths (both technical and non-technical)
* I'm self-organising and self-sufficient
* I have good organisational knowledge, and access to a network of people across the university
* I can speak and write about my work to all different sorts of audiences

### Growth Opportunities

* I'm bad at knowing when something is finished. You can help me with this by making sure things I am working on have clear acceptance criteria.
* It can sometimes take me a while to build rapport with new people. You can help me with this by identifying people I might have to work closely with in advance so I can get to know them beforehand.
* I need time to think and reflect before making big decisions or working out what my opinion is on something. You can help me with this by providing as much information as possible in advance.

### My Working Style

* I start work early in the morning, and start to lose focus by mid-afternoon. I try and do all of my high-value work earlier in the day where possible, and book all of my focus time when other people are less likely to be working so I can be more available for my team later in the day.
* I like to start off working alone, and then start collaborating once I have a better idea of what I can contribute to something.
* I prefer informal conversations with individuals or small groups rather than big meetings.
* I am a champion of both remote and asynchronous working, but also value being able to collaborate face-to-face with my team and other people I work with regularly.

### My Availability

* I keep my calendar updated with when I am working, whether I am remote or in the office, and where possible what I am working on.
* I generally take lunch between 12-1, but often don't take the full hour so I can finish earlier. Sometimes I use this time to work on personal projects or learn new things.
* Most days I need to be done with all work-related activities (including commuting) by 5pm.
* Please try not to book online meetings when I'm in the office, or book meetings that clash with other meetings I have already committed to, as that can make diary management challenging. 
* If something is genuinely urgent then let me know and I will find time to talk about it.

### What I Assume about Others

* That you are a good person
* That you want to do your best work
* That if you need my help with something you will ask me
* That you know what your job is better than I do
